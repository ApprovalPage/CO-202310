...
// stage content:
(lib.COAEPdental300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_1.setTransform(102.55,26.95,0.8095,0.8095,0,0,0,8,21.8);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(118).to({_off:false},0).wait(115).to({x:91.55,alpha:0},8).wait(3));

	// CTA
	this.instance_2 = new lib.CTA_mobile();
	this.instance_2.setTransform(242,27);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(118).to({_off:false},0).wait(115).to({alpha:0.8789},1).to({alpha:0},7).wait(3));

	// BKGD-rubine
	this.instance_3 = new lib.BKGDrubine();
	this.instance_3.setTransform(-63.75,49.2,2.4267,0.36,0,0,0,0.1,67.2);
...
p.nominalBounds = new cjs.Rectangle(-278,5,578.5,84.5);
// library properties:
lib.properties = {
